    ...
    <section className="relative">
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-24">
          <div v-for="meme in memes" key="meme" className="my-16">
            ...
            <div className="flex justify-between items-baseline mt-5">
              <p className="text-gradient-pink text-xl font-extrabold">{'meme.info.title'}</p>
            ...
            <div className="flex justify-between mt-4">
              <div className="text-center">
                ...
                <p className="text-gradient-pink font-bold">{'meme.info.total_donations / 1e24'} Ⓝ</p>
              </div>
              <div className="text-center">
                <p className="text-black text-sm font-bold">category</p>
                <p className="text-gradient-pink font-bold">{'meme.info.category'}</p>
              </div>
              <div className="text-center">
                <p className="text-black text-sm font-bold">score</p>
                <p className="text-gradient-pink font-bold">{'meme.info.vote_score'}</p>
              </div>
            </div>
            ...
            <div v-if="accountId">
              ...
              <div className="mt-2 btn-border-pink w-full h-12 p-0.5">
                <button click="openModal(meme)" className="btn-bg-pink">
            ...
            <div v-else>
              ...
              <div className="mt-2 btn-border-pink w-full h-12 p-0.5">
                <button click="signIn" className="btn-bg-pink">
                  <p className="btn-text-pink font-bold ">Comment / read comments</p>
                </button>
              </div>
            </div>
